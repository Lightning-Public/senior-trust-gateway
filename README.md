...
2026 모두의 AI 실험실 AI 서비스 경진대회 제출용 **실행 가능한 MVP + 제출문서/증빙 완성**이 현재 최우선 목표입니다.
...
MVP 정본은 이 저장소의 실행 가능한 prototype이며, aitestbed는 MVP를 대신 만드는 주체가 아니라 **플랫폼 활용 증빙과 필요한 최소 UI 참고**에 사용합니다.
...
## MVP — Hospital Kiosk Safe Guidance 20%
...
- [`aitestbed 플랫폼 활용 증빙 Runbook`](docs/contest/aitestbed-vibe-build-plan.md)
